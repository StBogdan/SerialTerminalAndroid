...
import com.hoho.android.usbserial.driver.util.HexDump;
...
public class FtdiSerialDriver implements UsbSerialDriver {
    ...
    private final UsbSerialPort mPort2;
    ...
    public FtdiSerialDriver(UsbDevice device) {
        ...
        mPort2= new FtdiSerialPort(mDevice, 128);
    }
    @Override
    ...
    public List<UsbSerialPort> getPorts() {
        ArrayList<UsbSerialPort> portList = new ArrayList<UsbSerialPort>();
        portList.add(mPort);
        portList.add(mPort2);
        return portList;
    }
